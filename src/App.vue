<template>
  <div class="min-h-screen flex flex-col bg-gradient-to-b from-light to-light dark:from-dark dark:to-dark">
    <!-- Header -->
    ...
    <main class="flex-grow container mt-3 mx-auto p-6 text-gray-700 dark:text-gray-400">
      <div class="text-center mb-8">
        ...
        <p class="md:text-xl font-extrabold mt-6 font-Roboto">Download videos from your favorite platforms ✨</p>
      </div>
     ...
     <!-- Download Form -->
      ...
      <!-- Video Previews -->
        <div v-show="videoUrl" class="mt-8 flex flex-col max-w-lg mx-auto h-auto bg-white dark:bg-gray-800 shadow-2xl rounded-lg overflow-hidden transform transition duration-300 hover:scale-105">
          <iframe v-if="platform === 'youtube'" :src="embedUrl" frameborder="0" allowfullscreen class="w-full h-[250px] rounded-t-lg"></iframe>
          <video v-else :src="videoUrl" controls class="w-full h-[250px] rounded-t-lg"></video>
          <div class="p-4 bg-gradient-to-b from-tomato-500 to-tomato-800 text-gray-100">
